...
import org.choongang.member.services.FileUploadDoneService;
    ...
    public BoardData save(RequestBoard form) {
        ...
        if (seq != null && mode.equals("update")) {//글 수정
            ...
            data = BoardData.builder()
                    ...
                    .ip(request.getRemoteAddr())//사용자쪽 IP 주소
        ...
        if (StringUtils.hasText(form.getGuestPw())) {
            data.setGuestPw(encoder.encode(form.getGuestPw()));
        }
